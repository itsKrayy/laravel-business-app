...
<div class="container">
    ...
    <div class="w-100">
        <div class="card">
            <div class="card-header">Krayy Sounds Products</div>
            <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($product as $list)
                                <tr>
                                    <td>{{ $list->id }}</td>
                                    <td>{{ $list->productTitle }}</td>
                                    <td>{{ $list->desc }}</td>
                                    <td>
                                        <a href="{{url('/admin/'.$list->id.'/edit')}}" title="Edit Student">
                                            <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-alt" aria-hidden="true"></i> Edit
                                            </button>
                                        </a>
